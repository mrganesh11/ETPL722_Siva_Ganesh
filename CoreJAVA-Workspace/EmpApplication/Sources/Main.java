...
public class Main extends WOComponent 
{
	...
	public WOComponent submit()
	{
		...
		EmpDetailsPage empPage=(EmpDetailsPage) pageWithName("EmpDetailsPage");
		//empPage.empDetailsList.addObject(emp);
		empPage.empObj=emp;
		return empPage;
	}
